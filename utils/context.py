...
class AgentContext:
    ...
    analytical_execution_plan: Dict[str, Any] = field(default_factory=dict)
    applied_transformations: List[Dict[str, Any]] = field(default_factory=list)
    transformation_results: List[Dict[str, Any]] = field(default_factory=list)
    ...
    metric_filtering_policy: Dict[str, Any] = field(default_factory=dict)
    visualization_plan: List[Dict[str, Any]] = field(default_factory=list)
    followup_comparison_results: Dict[str, Any] = field(default_factory=dict)
